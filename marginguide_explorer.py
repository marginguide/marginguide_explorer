...
def rankings():
    try:
        ...
        if len(keywords) > 0:
            ...
            with SB(headless2=True, uc=True, log_cdp=False, block_images=True, incognito=True, mobile=True) as self:
...
#             with SB(headless2=False, uc=True, log_cdp=False, block_images=True, incognito=True, mobile=True) as self:
#                 input_ranking_log('s-1')
...
#                     time.sleep(random.uniform(1,2))
#                     xpath = "//input[@name='q']"
#                     self.type(xpath, keyword)
#                     time.sleep(1)
#                     xpath = "//a[@id='headerSearchBtn']"
#                     self.slow_click(xpath)
#                     time.sleep(random.uniform(1,3))
#                     list_1 = "//label[@for='listSize-36']"
#                     list_2 = "//label[@for='listSize-72']"
#                     self.hover_and_click(list_1, list_2)
